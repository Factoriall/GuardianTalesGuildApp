...
import org.techtown.gtguildraid.models.dao.BossDao;
import org.techtown.gtguildraid.models.dao.FavoritesDao;
import org.techtown.gtguildraid.models.dao.HeroDao;
import org.techtown.gtguildraid.models.dao.MemberDao;
import org.techtown.gtguildraid.models.dao.RaidDao;
import org.techtown.gtguildraid.models.dao.RecordDao;
...
@Database(entities = {GuildMember.class, Boss.class, Raid.class, Hero.class, Record.class, Favorites.class}, version = 32, exportSchema = false)
...
public abstract class RoomDB extends RoomDatabase {
    ...
    //오르카 데이터 추가 - 2021.09.25
    static final Migration MIGRATION_29_30 = new Migration(29, 30) {
        @Override
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL("INSERT INTO hero (koreanName, englishName, element, star, role) "
                    + "VALUES ('오르카', 'orca', 2, 3, 3)");
        }
    };

    //칸나 및 하나 데이터 추가 - 2021.11.14
    static final Migration MIGRATION_30_31 = new Migration(30, 31) {
        @Override
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL("INSERT INTO hero (koreanName, englishName, element, star, role) "
                    + "VALUES ('칸나', 'kanna', 6, 3, 1)");
            database.execSQL("INSERT INTO hero (koreanName, englishName, element, star, role) "
                    + "VALUES ('하나', 'hana', 2, 3, 1)");
        }
    };

    //캐럴 및 클라 데이터 추가 - 2022.01.01
    static final Migration MIGRATION_31_32 = new Migration(31, 32) {
        @Override
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL("INSERT INTO hero (koreanName, englishName, element, star, role) "
                    + "VALUES ('캐럴', 'carol', 4, 3, 1)");
            database.execSQL("INSERT INTO hero (koreanName, englishName, element, star, role) "
                    + "VALUES ('클라라', 'clara', 1, 3, 3)");
        }
    };
